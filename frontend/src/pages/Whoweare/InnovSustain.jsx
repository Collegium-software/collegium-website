...
import sustain from "../../images/WhoWeAre/sustain2.jpeg";
import Button from "../../components/button/Button";
const InnovSustain = () => {
  return (
    <div className="innov-sustain-section">
      <div className="innovation">
        <h2>It's about innovation</h2>
        <p>
          "We've always done it this way" is a dangerous statement. Instead, we
          ask <strong>"What can we do differently?"</strong>
          <br />
          <br /> Would we change the way we write our contracts? Would we make
          money flow faster and make supply chains more efficient? Would we
          better align all direct and indirect stakeholder interests towards
          just and fair costs? <br />
          <br />
      ...
      <div className="sustainability">
        ...
        <div className="sustain-button">
          <Button label="Contact Us" color="black" to="/contactus" />
        </div>
      </div>
    </div>
