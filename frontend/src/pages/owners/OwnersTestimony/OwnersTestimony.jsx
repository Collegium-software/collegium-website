...
const OwnersTestimonyHeader = () => {
  return (
    <div className="ownersTestimonyHeader">
      ...
      <Line blackLine />
      <p>
        “We are thrilled with our partnership with Collegium." - CEO OF CETANA
      </p>
    </div>
  );
};
  ...
  return (
    <div className="owners-Testimony-Page">
      ...
      <div className="owners-Partners-Container ">
        <OwnersPartners imageUrl={"Partner1"} title="CETANA GROUP" />
        <OwnersPartners imageUrl={"Partner2"} title="NEXT ARCHITECTURE" />
        <OwnersPartners imageUrl={"Partner3"} title="MCW ENGINEERING" />
        <OwnersPartners imageUrl={"Partner4"} title="SMOKY LAKE" />
      </div>
    </div>
  );
};
