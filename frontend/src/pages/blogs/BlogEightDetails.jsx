...
const BlogEightDetails = () => {
  ...
  const undesiredUrl = "/blogs/blog8";
        ...
        {loading ? (
          ...
          <>
            <div className="blog-hero-pic">
              <img
                src={`data:image/jpeg;base64,${allBlogs[7].image}`}
                alt={allBlogs[7].title}
              />
            </div>
            <div className="blogpage-full-article">
              <div className="blogpageFullArticle-title">
                <h2>{allBlogs[7].title}</h2>
                <p>
                  <strong>Written by:</strong> {allBlogs[7].author}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{allBlogs[7].date}
                </p>
              </div>
              <div className="blogpageFullArticle-description">
                <p
                  dangerouslySetInnerHTML={{ __html: allBlogs[7].description }}
                />
                {/* <p>{allBlogs[7].description}</p> */}
              </div>
            </div>
...
export default BlogEightDetails;
