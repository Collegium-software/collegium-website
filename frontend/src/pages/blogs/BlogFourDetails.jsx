...
const BlogFourDetails = () => {
  ...
  const undesiredUrl = "/blogs/blog4";
        ...
        {loading ? (
          ...
          <>
            <div className="blog-hero-pic">
              <img
                src={`data:image/jpeg;base64,${allBlogs[3].image}`}
                alt={allBlogs[3].title}
              />
            </div>
            <div className="blogpage-full-article">
              <div className="blogpageFullArticle-title">
                <h2>{allBlogs[3].title}</h2>
                <p>
                  <strong>Written by:</strong> {allBlogs[3].author}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{allBlogs[3].date}
                </p>
              </div>
              <div className="blogpageFullArticle-description">
                <p
                  dangerouslySetInnerHTML={{ __html: allBlogs[3].description }}
                />
                {/* <p>{allBlogs[3].description}</p> */}
              </div>
            </div>
