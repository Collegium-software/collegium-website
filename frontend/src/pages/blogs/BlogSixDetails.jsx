...
const BlogSixDetails = () => {
  ...
  const undesiredUrl = "/blogs/blog6";
        ...
        {loading ? (
          ...
          <>
            <div className="blog-hero-pic">
              <img
                src={`data:image/jpeg;base64,${allBlogs[5].image}`}
                alt={allBlogs[5].title}
              />
            </div>
            <div className="blogpage-full-article">
              <div className="blogpageFullArticle-title">
                <h2>{allBlogs[5].title}</h2>
                <p>
                  <strong>Written by:</strong> {allBlogs[5].author}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{allBlogs[5].date}
                </p>
              </div>
              <div className="blogpageFullArticle-description">
                <p
                  dangerouslySetInnerHTML={{ __html: allBlogs[5].description }}
                />
                {/* <p>{allBlogs[5].description}</p> */}
              </div>
            </div>
