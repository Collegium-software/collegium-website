...
const BlogNineDetails = () => {
  ...
  const undesiredUrl = "/blogs/blog9";
        ...
        {loading ? (
          ...
          <>
            <div className="blog-hero-pic">
              <img
                src={`data:image/jpeg;base64,${allBlogs[8].image}`}
                alt={allBlogs[8].title}
              />
            </div>
            <div className="blogpage-full-article">
              <div className="blogpageFullArticle-title">
                <h2>{allBlogs[8].title}</h2>
                <p>
                  <strong>Written by:</strong> {allBlogs[8].author}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{allBlogs[8].date}
                </p>
              </div>
              <div className="blogpageFullArticle-description">
                <p
                  dangerouslySetInnerHTML={{ __html: allBlogs[8].description }}
                />
                {/* <p>{allBlogs[8].description}</p> */}
              </div>
            </div>
...
export default BlogNineDetails;
