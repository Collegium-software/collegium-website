...
const BlogFiveDetails = () => {
  ...
  const undesiredUrl = "/blogs/blog5";
        ...
        {loading ? (
          ...
          <>
            <div className="blog-hero-pic">
              <img
                src={`data:image/jpeg;base64,${allBlogs[4].image}`}
                alt={allBlogs[4].title}
              />
            </div>
            <div className="blogpage-full-article">
              <div className="blogpageFullArticle-title">
                <h2>{allBlogs[4].title}</h2>
                <p>
                  <strong>Written by:</strong> {allBlogs[4].author}
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{allBlogs[4].date}
                </p>
              </div>
              <div className="blogpageFullArticle-description">
                <p
                  dangerouslySetInnerHTML={{ __html: allBlogs[4].description }}
                />
                {/* <p>{allBlogs[4].description}</p> */}
              </div>
            </div>
